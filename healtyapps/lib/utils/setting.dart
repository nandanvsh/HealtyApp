...
setImage(val) {
  if (val == '01d')
    ...
    return './images/weather-icons/PartlyCloudyDay.png';
  else if (val == '02n')
    return './images/weather-icons/PartlyCloudyNight.png';
  else if (val == '03d')
    return './images/weather-icons/Mist.png';
  else if (val == '04d')
    return './images/weather-icons/Overcast.png';
  else if (val == '09d')
    return "./images/weather-icons/ModRain.png";
  else if (val == '10d')
    return "./images/weather-icons/ModRainSwrsDay.png";
  else if (val == '10n')
    return "./images/weather-icons/ModRainSwrsNight.png";
  else if (val == '11d')
    return "./images/weather-icons/CloudRainThunder.png";
  else if (val == '13d')
    return "./images/weather-icons/OccLightSnow.png";
  else
